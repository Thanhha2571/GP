...
const WorkingSchedule = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (userObject?.role === "Admin") {
                response = await axios.post('http://localhost:8800/api/admin/manage-shift/create', shiftData, { withCredentials: true });
            }

            if (userObject?.role === "Inhaber") {
                response = await axios.post('http://localhost:8800/api/inhaber/manage-shift/create', shiftData, { withCredentials: true });
            }
    ...
    const handleDeleteShiftSubmit = async (e) => {
        ...
        try {
            ...
            if (userObject?.role === "Admin") {
                response = await axios.delete(`http://localhost:8800/api/admin/manage-shift/delete?code=${selectedShiftDelete}`, { withCredentials: true });
            }

            if (userObject?.role === "Inhaber") {
                response = await axios.delete(`http://localhost:8800/api/inhaber/manage-shift/delete?code=${selectedShiftDelete}`, { withCredentials: true });
            }
    ...
    const handleEditShiftSubmit = async (e) => {
        ...
        try {
            ...
            if (userObject?.role === "Admin" && formEdit.name_edit !== "" && formEdit.start_time_edit === "" && formEdit.end_time_edit === "") {
                response = await axios.put(`http://localhost:8800/api/admin/manage-shift/update?code=${selectedShiftEdit}`, {
            ...
            if (userObject?.role === "Inhaber" && formEdit.name_edit !== "" && formEdit.start_time_edit === "" && formEdit.end_time_edit === "") {
                response = await axios.put(`http://localhost:8800/api/inhaber/manage-shift/update?code=${selectedShiftEdit}`, {
                    name: formEdit.name_edit
                }, { withCredentials: true });
